"""
patch_2026_04_08_polish_v10.py — slide 27 bullet 1 reframe.

Refines v9: keeps bullets 2/3/4 and the prior_distributions figure
exactly as Jose had them, but rewrites bullet 1 to capture his sharper
intuition. RQ1 isn't null because evaluators are taking a cognitive
shortcut (v9's "anchor automatically") — it's null because at the
first wager there's literally no information to discriminate on, so
being reserved is rational. The outcome is the FIRST piece of
information that gives latent priors something to interpret. This also
flags the contrast with the standard discrimination literature, which
typically finds baseline gender gaps.

Subtitle and bullet 1 use Jose's "leak in" phrasing.
"""
...
BULLETS = [
    ...
    (
        ...
        "When men endorse with confidence it carries information "
        "that can be both praised or penalized, and the outcome "
        "moves trust accordingly.",
    ),
    (
